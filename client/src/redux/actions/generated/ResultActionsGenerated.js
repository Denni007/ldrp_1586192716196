...
let actionsFunction = {
  ...
  // Find by student
  findBystudent: function(key) {
    return function(dispatch) {
      return ResultApi
        .findBystudent(key)
        .then(item => {
          dispatch(actionsFunction.findBystudentSuccess(item));
        })
        .catch(error => {
          throw error;
        });
  ...
  findBystudentSuccess: function(item) {
    return { type: types.FINDBYSTUDENT_RESULT_SUCCESS, payload: item };
  },
