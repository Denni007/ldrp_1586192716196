    ...
    const sideList = (
      <div className={classes.list}>
        <div className="navbar-drawer-header">
          ...
          <div className="navbar-drawer-text">ldrp</div>
        </div>
        <Divider />
        <List>
          {/* START LINK MENU */}
           ...
           <Link to="/batchs">
            <ListItem button key="batch">
              ...
              <ListItemText className="menu-text" primary="batch" />
            </ListItem>
          </Link>{" "}            
           <Link to="/branchs">
            <ListItem button key="branch">
              ...
              <ListItemText className="menu-text" primary="branch" />
            </ListItem>
          </Link>{" "}            
           <Link to="/professors">
            <ListItem button key="professor">
              <ListItemIcon>
                <ArrowForwardIos />
              </ListItemIcon>
              <ListItemText className="menu-text" primary="professor" />
            </ListItem>
          </Link>{" "}            
           <Link to="/results">
           ...
           <Link to="/semesters">
            <ListItem button key="semester">
              <ListItemIcon>
                <ArrowForwardIos />
              </ListItemIcon>
              <ListItemText className="menu-text" primary="semester" />
            </ListItem>
          </Link>{" "}            
           <Link to="/students">
           ...
           <Link to="/subjects">
            <ListItem button key="subject">
              ...
              <ListItemText className="menu-text" primary="subject" />
            </ListItem>
          </Link>{" "} {/* END LINK MENU */}
        </List>
      </div>
